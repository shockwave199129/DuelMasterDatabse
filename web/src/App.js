    ...
    <>
      ...
      <div className="App">
        <header className="App-header">
          <Container>
            <Col>
              <h4 className='pt-3 pb-3'>Hi 👋, thanks for stopping by!</h4>
              <Card className='flex-sm-row align-items-center'>
                <Col md={6}>
                  <img src='duel_masters_12_by_nakamura8_d9yjode.jpg' alt='image 1' />
                </Col>
              ...
              <Card className='flex-sm-row align-items-center'>
                ...
                <Col md={6}>
                  <img src='duel_masters_14_by_nakamura8_d9yo12l.jpg' alt='image 2' />
                </Col>
              </Card>
              <Card className='flex-sm-row align-items-center'>
                <Col md={6}>
                  <img src='duel_masters_10_by_nakamura8_d9ae3am.jpg' alt='image 3' />
                </Col>
                <Col md={6} className='p-4'>
